...
def recognise( Modified_Sudoku_Image):

#    print(Warped_Sudoku_Image.shape)
    ...
    # = cv2.imread(sudoku_image_path)
    ###Load the image to process
    Output_Image = np.zeros(Modified_Sudoku_Image.shape,np.uint8)
    ...
    for Contour in Contours:
        ...
        if cv2.contourArea(Contour)>30 and cv2.contourArea(Contour)<1000:
            ...
            if  Y_Height>22 and Y_Height<40:
                ...
                cv2.rectangle(Modified_Sudoku_Image,(Abscissa,Ordinate),(Abscissa+X_Width,Ordinate+Y_Height),(0,255,0),2)
    ...
    cv2.imshow('Warped_Sudoku_Image',Modified_Sudoku_Image)
    cv2.imwrite('../images/sudoku_with_boundary.png',Modified_Sudoku_Image)
    #cv2.imshow('Output_Image',Output_Image)
    cv2.imwrite('../images/recognitions.png',Output_Image)
    #cv2.waitKey(0)
    #print Sudoku_Text
    return Sudoku_Text
